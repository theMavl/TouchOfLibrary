# Generated by Django 2.0.1 on 2018-03-05 16:42
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('document', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='library.Document')),
                ('document_copy', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='library.DocumentInstance')),
        ...
        migrations.AddField(
            model_name='giveout',
            name='patron',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.PROTECT, to='library.PatronInfo'),
        ),
        migrations.AddField(
            model_name='giveout',
            name='user',
