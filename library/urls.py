...
urlpatterns = [
    ...
    url(r'^document/upload_picture/(?P<pk>\d+)$', upload_prompt, name='document-upload-picture'),
    url(r'^document/upload_picture_complete/', direct_upload_complete, name='document-upload-complete'),
